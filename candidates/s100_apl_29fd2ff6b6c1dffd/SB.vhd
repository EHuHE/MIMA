...
architecture Structural of SB is
    ...
    signal y3_f_g0_p03_right, y3_f_g0_p12_left, y3_f_g0_p12_right, y3_f_g1_p47_common, y3_f_g1_p47_right, y3_f_g1_p56_common, y3_f_g1_p56_left, y3_f_g1_p56_right : STD_LOGIC;
    signal y3_f_g2_p1011_common, y3_f_g2_p1011_left, y3_f_g2_p1011_right, y3_f_g2_p89_common, y3_f_g2_p89_left, y3_f_g2_p89_right, y3_f_g3_p1213_common, y3_f_g3_p1213_left : STD_LOGIC;
    ...
    signal y4_st_part_6222_tailpack_c9best_pg0dm_pg123fact_c0_bx3_a1_pg2_common, r47_y4_and4_negative, y4_st_part_6222_tailpack_c9best_pg0dm_pg123fact_c0_bx3_a1_pg3_left, y4_st_part_6222_tailpack_c9best_pg0dm_pg123fact_c0_bx3_a1_pg3_right, y5_f_g0_c1_nprod, y5_f_g0_c2_nprod, y5_f_g0_c3_nprod, y5_f_g1_c0_nprod : STD_LOGIC;
    signal y5_f_g1_c1_nprod, y5_f_g1_c2_nprod, y5_f_g2_p78_xnor, y5_f_g3_p1012_common, y5_f_g3_p1012_left, y5_f_g3_p1012_right, y5_f_g3_p911_common, y5_f_g3_p911_left : STD_LOGIC;
    signal y5_f_g3_p911_right, y0_f_g1_p13_neg, y0_f_g2_p78_lor, y0_f_g3_x0_res_or, y0_st_g1pair_tail_g3x0_phys_p13c405_g3ix4a1_n1, r47_y1_and4_negative, y1_f_g0_neg, y1_f_g1_p57_lor : STD_LOGIC;
    signal y1_f_g2_p1011_lor, y1_f_g3_p1213_neg, y2_f_g0_neg, y2_f_g1a_lor, y2_f_g1b_lor, y2_f_g2b_lor, y2_f_g3a_lor, y2_f_g3b_lor : STD_LOGIC;
    signal y3_f_g0_p03_lor, y3_f_g0_p12_lor, y3_f_g1_p47_lor, y3_f_g1_p56_lor, y3_f_g2_p1011_lor, y3_f_g2_p89_lor, y3_f_g3_p1213_neg, y4_st_part_6222_tailpack_c9best_pg0dm_pg123fact_c0_bx3_a1_pg0_left_pos : STD_LOGIC;
    signal y4_st_part_6222_tailpack_c9best_pg0dm_pg123fact_c0_bx3_a1_pg0_right_pos, y4_st_part_6222_tailpack_c9best_pg0dm_pg123fact_c0_bx3_a1_pg1_nor, y4_st_part_6222_tailpack_c9best_pg0dm_pg123fact_c0_bx3_a1_pg2_nor, y4_st_part_6222_tailpack_c9best_pg0dm_pg123fact_c0_bx3_a1_pg3_nor, y5_f_g0_neg, y5_f_g1_neg, y5_f_g2_p78_neg, y5_f_g3_p1012_lor : STD_LOGIC;
    signal y0_f_g2_neg, y0_f_g3_neg, y0_st_g1pair_tail_g3x0_phys_p13c405_g3ix4a1_n2, y2_f_g1_neg, y2_f_g2_neg, y2_f_g3_neg, y3_f_g0_neg, y3_f_g1_neg : STD_LOGIC;
    signal y3_f_g2_neg, y4_st_part_6222_tailpack_c9best_pg0dm_pg123fact_c0_bx3_a1_pg0_nor, r40_y5k2_d5a95ec45789ce72_n0, y5_f_g3_neg, y0_st_g1pair_tail_g3x0_phys_p13c405_g3ix4a1, y1_f_g1_p46_xnor, r42_y1k3_5b94b51f9e719569_n0, r42_y1k3_5b94b51f9e719569_n1 : STD_LOGIC;
...
begin
    ...
    u_y0_f_g1_c0_nprod : NAND4_X1 Port Map (A1 => y0_bx1, A2 => y0_bx2, A3 => y0_ix3, A4 => y1_bx4, ZN => y0_f_g1_c0_nprod);
    ...
    u_y0_f_g2_p78_common : AND3_X1 Port Map (A1 => y0_ix0, A2 => y0_ix3, A3 => y2_bx4, ZN => y0_f_g2_p78_common);
    ...
    u_y1_f_g0_c3_nprod : NAND4_X1 Port Map (A1 => y1_ix0, A2 => y0_bx1, A3 => y5_bx3, A4 => y1_bx4, ZN => y1_f_g0_c3_nprod);
    ...
    u_y2_f_g0_c0_nprod : NAND4_X1 Port Map (A1 => y2_ix1, A2 => y2_bx2, A3 => y0_bx4, A4 => y2_bx5, ZN => y2_f_g0_c0_nprod);
    ...
    u_y2_f_g2b_left : NAND3_X1 Port Map (A1 => y0_bx2, A2 => y2_ix3, A3 => y1_bx5, ZN => y2_f_g2b_left);
    u_y2_f_g2b_right : NAND3_X1 Port Map (A1 => y0_ix5, A2 => y0_ix1, A3 => y3_bx3, ZN => y2_f_g2b_right);
    u_y2_f_g3a_common : AND3_X1 Port Map (A1 => y2_ix1, A2 => y2_ix2, A3 => y2_ix5, ZN => y2_f_g3a_common);
    ...
    u_y3_f_g0_p12_right : NAND3_X1 Port Map (A1 => y0_ix5, A2 => y3_bx3, A3 => y3_bx1, ZN => y3_f_g0_p12_right);
    ...
    u_y5_f_g3_p1012_left : NAND3_X1 Port Map (A1 => y1_bx4, A2 => y0_ix5, A3 => y0_ix3, ZN => y5_f_g3_p1012_left);
    ...
    u_y1_f_g1_p57_lor : OAI21_X1 Port Map (B1 => y0_ix2, B2 => y0_bx1, A => y1_f_g1_p57_right_neg, ZN => y1_f_g1_p57_lor);
    ...
    u_y3_f_g1_p47_lor : NAND2_X1 Port Map (A1 => y0_f_g2_p78_right, A2 => y3_f_g1_p47_right, ZN => y3_f_g1_p47_lor);
